...
<body>
  ...
  <div class="content">
    ...
    <section id="buku-terbaru" class="section-buku-terbaru">
      <div class="container">
        ...
        <div class="lihat-semua-wrapper">
          <a href="/buku" class="lihat-semua-btn">Lihat Semua Buku</a>
        </div>
      </div>
    </section>
    ...
    <div id="pinjamModal" class="modal">
      <div class="modal-content">
        <div class="close-btn" onclick="closeModal()">✖</div>
        <h2 style="margin-bottom: 20px;">Peminjaman Buku</h2>
        <form action="/pinjam" method="post">
          <input type="hidden" name="id_buku" id="pinjam_id_buku">

          <label for="tanggal_pinjam">Tanggal Peminjaman</label>
          <input type="date" name="tanggal_pinjam" id="tanggal_pinjam" value="<?= date('Y-m-d') ?>" readonly required>
    ...
    <section class="about-section" id="about">
      <div class="about-container">
        <div class="about-text">
          <h2>Tentang <span class="highlight">SIRUBA</span></h2>
          <p><strong>SIRUBA</strong> (Sistem Informasi Ruang Baca) adalah platform digital yang memudahkan pengguna dalam mencari, menjelajah, dan mengakses koleksi buku secara online.</p>
        </div>
        <div class="about-image">
          <img src="/assets/img/siruba.png" alt="Ilustrasi SIRUBA">
        </div>
      </div>
    </section>
  </div>
  ...
  <script>
    function showBookDetail(el) {
      ...
      const title = el.dataset.judul;
      const image = el.dataset.img;
      const author = el.dataset.penulis;
      const kategori = el.dataset.kategori;
      const description = el.dataset.deskripsi;
